...
export function FinalCta() {
  return (
    <section className="relative overflow-hidden border-t border-border-subtle bg-bg-base py-28 sm:py-36">
      {/* Accent glow band */}
      <div
        aria-hidden
        ...
        style={{
          background:
            "radial-gradient(ellipse 60% 50% at 50% 50%, rgba(255,165,0,0.22), transparent 70%)",
        }}
      />
